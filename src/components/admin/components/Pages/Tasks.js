    ...
    <>
      ...
      >
        ...
        <section class="wrapper">
          <div class="row">
            <div class="col-lg-12">
              <span className="p-3">TaskList</span>
          ...
          <Form onSubmit={handleSubmit(onSubmit)} autoComplete="off">
            <Form.Group className="pb-4">
              ...
              {errors.name && errors.name.type === "required" && (
                <span className="errMsg">Please Enter Task</span>
              )}
            </Form.Group>
            ...
            <Form.Group className="pb-3">
              ...
              >
                ...
                <option value="assignee1"></option>
                <option value="assignee2"></option>
                <option value="assignee3"></option>
              </Form.Control>
              {/* <Form.Control
                type="name"
              ...
              /> */}
              {errors.name && errors.name.type === "required" && (
                <span className="errMsg">Please Enter Assignee Name</span>
              )}
            </Form.Group>
            ...
            <Form.Group className="pb-3">
              ...
              {errors.taskPriority &&
                errors.taskPriority.type === "required" && (
                  <span className="errMsg">Please select a task priority</span>
                )}
              <Form.Group className="pb-3">
                <Form.Label htmlFor="taskdescription">Task-Description</Form.Label>
                <Form.Control as="textarea" id="Textarea" placeholder="Task Description" />
                
                {errors.taskdescription &&
                errors.taskdescription.type === "required" && (
                  <span className="errMsg">Enter Task Description</span>
                )}
              </Form.Group>
              
            </Form.Group>

            <div className="_add_float ">
              <Button
                variant="secondary"
                onClick={handleClose}
          ...
          <Form onSubmit={handleSubmit1(onUpdate)} autoComplete="off">
            <Form.Group className="pb-4">
              ...
              <Form.Control
                ...
                placeholder="Please enter Task-Title"
                value={updateName}
                {...register1("task-title", {
                  required: false,
                  onChange: (e) => setUpdateName(e.target.value),
                })}
              />
              {errors1.name && errors1.name.type === "required" && (
                <span className="errMsg">Enter Task-Title</span>
              )}
            </Form.Group>
